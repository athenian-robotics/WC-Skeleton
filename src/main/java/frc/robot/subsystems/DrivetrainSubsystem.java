    ...
    public DrivetrainSubsystem(RobotType robotType) throws ClassCastException {
        ...
        switch (robotType) { // OFFICIAL Drivetrain utilizes TalonFX's, which are integrated into the motors themselves.
            ...
            case KITBOT: // KITBOT utilizes TalonSRXs as its motor controllers
                ...
                break;
            case REBOOT: // Reboot uses TalonFX's and we use our own ARCTalon class
                leftMotors = new MotorControllerGroup(new WPI_TalonFX(leftMotor1Port), new WPI_TalonFX(leftMotor2Port));
                rightMotors = new MotorControllerGroup(new WPI_TalonFX(rightMotor1Port), new WPI_TalonFX(rightMotor2Port));
        }
